...
func Make(password string) (hash string, err error) {
	return CreateHash(password)
}

func Match(password string, hash string) (match bool, err error) {
...
func CreateHash(password string, param ...*Params) (hash string, err error) {
	var params *Params
	if len(param) > 0 {
		params = param[0]
	} else {
