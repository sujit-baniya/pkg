...
import (
	...
	sessions2 "github.com/sujit-baniya/frame/middlewares/server/sessions"
	"gorm.io/gorm"
)
...
func (st *Store) Options(options sessions2.Options) {
	if st.SessionOpts == nil {
		st.SessionOpts = options.ToGorillaOptions()
	}
}
